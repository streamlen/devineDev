  ...
  return (
    <Fade bottom>
      <div className=" mt-16 bg-gray-50">
        ...
        <Button
            className="text-xl flex justify-center mx-auto px-12 py-3 mt-5 bg-theme-purple text-white rounded-full border-2 border-theme-purple hover:bg-dark-theme-purple border-purple-800 transition duration-200 focus:outline-none"
            type="button"
            onClick={submitPost}
          >
            Submit
